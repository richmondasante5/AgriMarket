...
<header class="main-header">
  ...
  <nav class="navbar navbar-static-top" style="background: #31993E; height: 75px; position: ; width: 100%;">
    <div class="container">
      <div class="navbar-header">
        <a href="index.php" class="navbar-brand"><i><img src="images/logo.jpg" height="40" width="40" style="border-radius: 100px;">
        </i><b>Agri</b>Market</a>
      ...
      <div class="collapse navbar-collapse pull-left" id="navbar-collapse" style="height: 50px;">
        <ul class="nav navbar-nav">
          <li><a href="index.php" style="font-size: 24px; "><i style="margin-right: 4px;" class="fa fa-home" aria-hidden="true"></i></a></li>
             ...
             if($result->num_rows>0){
              ...
              echo '
                <li class="dropdown user user-menu">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="'.$profile.'" class="user-image" alt="">
