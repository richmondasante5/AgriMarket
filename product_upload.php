	        						...
	        						<form method="POST" action="inc/upload.php" enctype="multipart/form-data">
							     		<div class="col-sm-6" style="margin-top: ;">
							     			<div style="width: 80%">
                                            	...
                                            	<input class="form-control py-4" id="inputusername" type="text" name="phone" placeholder="" required style="height: 40px;" />
												
												<label>Address</label><br>
                                            	<input class="form-control py-4" id="inputusername" type="text" name="address" placeholder="" required style="height: 40px;" />
